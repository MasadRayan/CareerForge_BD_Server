...
const callGroqForFeedback = async (question, answer) => {
    let raw;
    try {
...
const getQuestionFromDB = async (id) => {
...
const submitAnswerToDB = async (userId, questionId, payload) => {
    const question = await prisma.behavioralQuestions.findUnique({
        where: { id: questionId },
    ...
    const feedback = await callGroqForFeedback(question.question_text, payload.answer_text);
...
//# sourceMappingURL=behavioral.service.js.map
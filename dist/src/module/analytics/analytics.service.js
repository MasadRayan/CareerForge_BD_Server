...
const getUserStatus = async (userId) => {
    const [subscription, usageQuota, streak, cvCount, analysisCount, roadmapCount, quizTotal, quizCorrect, behavioralCount, latestReadiness,] = await Promise.all([
...
const getAdminAnalytics = async () => {
    ...
    const [activeSubscribers, totalRevenue, mrr, userSplit, newSignupsThisMonth, newSubscriptionsThisMonth, cancelledLast30, totalUsers, totalAnalyses, totalCvs, totalRoadmaps, allRevenueTx,] = await Promise.all([
